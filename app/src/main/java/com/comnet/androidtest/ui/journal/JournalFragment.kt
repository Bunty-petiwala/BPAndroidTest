package com.comnet.androidtest.ui.journal
...
import com.comnet.androidtest.databinding.FragmentJournalBinding
...
class JournalFragment : Fragment() {
     ...
     */
    private fun getNews(domain: String) {
        mViewModel.getNewsArticles(domain = domain).observe(viewLifecycleOwner, androidx.lifecycle.Observer {
            when {
                it.status.isLoading() -> {
